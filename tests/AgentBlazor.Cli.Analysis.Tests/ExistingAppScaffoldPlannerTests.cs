...
public sealed class ExistingAppScaffoldPlannerTests : IDisposable
{
    ...
    public async Task ApplyAsync_WhenAgentBlazorPackageExistsButMudBlazorPackageIsMissing_AddsMudBlazorReference()
    {
        var projectPath = CreateProject(
            ...
            csprojBody: """
                <Project Sdk="Microsoft.NET.Sdk.Web">
                  ...
                  <ItemGroup>
                    <PackageReference Include="AgentBlazor" Version="0.1.0-preview.3" />
                  </ItemGroup>
                </Project>
                """,
            programBody: """
        ...
        Assert.Contains("""<PackageReference Include="AgentBlazor" Version="0.1.0-preview.3" />""", projectText, StringComparison.Ordinal);
