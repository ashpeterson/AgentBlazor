...
- GitHub Packages workflow `publish-github-packages-preview` run `24597951350` passed for `0.1.0-preview.8` on commit `79cf68df3c448868d1e90a845d3629da20cb5672`.
...
- The earlier GitHub Packages published-feed preflight was blocked by missing local credentials; that is now resolved by the authenticated `gh` session and the `0.1.0-preview.8` validation above.
