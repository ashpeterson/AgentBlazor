...
function renderTitleCard(outputPath, config) {
  ...
  const filter = [
    ...
    `drawtext=fontfile=${fontRegular}:text='dotnet add package AgentBlazor --version 0.1.0-preview.10 --source github-agentblazor':x=112:y=208:fontsize=18:fontcolor=white@0.58`,
